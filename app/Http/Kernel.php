...
use App\Http\Middleware\CheckCartEmpty;
use App\Http\Middleware\ContactAuth;
...
//            \App\Http\Middleware\VerifyCsrfToken::class,
    ...
    protected $routeMiddleware = [
        ...
        'check_auth' => AuthCheck::class,
        'cart_empty' => CheckCartEmpty::class,
        'blocked' => CheckBlocked::class,
        'prevent_auth' => PreventAuth::class,
        'contact_auth' => ContactAuth::class,
