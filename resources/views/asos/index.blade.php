                    ...
                    <div class="block-nav-categori">
                        ...
                        <div class="block-content">
                            ...
                            <ul class="ui-categori">
                                                            ...
                                                            <div class="col-sm-3">
                                                                ...
                                                                <ul>
                                                                    @foreach($category['sub'][$j]->sub as $key=>$subSub)
                                                                        @if($key<=5)
                                                                            <li>
                                                                                <a href="/{{$siteslug}}/category/{{$subSub->subSubcatName}}/{{$subSub->asosCategoryId}}/1">
                                ...
                                @endforeach
                                <li class="parent">
                                    <a href="/asos/categoryList" class="all-category">
    <span class="icon">
                    ...
                    <div class="banner-slide latest-deal col-xs-6 block-service-mobile">
                        <div class="block-deals-of block-deals-of-opt1">
                            <div class="block-title">
                                ...
                                <div class="heading-title">מוצר היום</div>
                            </div>
                            <div class="block-content">
                                        ...
                                        <div class="product-item  product-item-opt-1 ">
                                            ...
                                            <div class="product-item-info">
                                                ...
                                                <div class="product-item-detail">
                                                    <strong class="product-item-name"  style="min-height: 60px; height: 60px; overflow: hidden;"><a
