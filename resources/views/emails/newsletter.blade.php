    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" style="min-width: 320px;"><tr><td align="center" bgcolor="#eff3f8">
                <table border="0" cellspacing="0" cellpadding="0" class="table_width_100" width="100%" style="max-width: 680px; min-width: 300px;">
                    <tr style="text-align: center; background-color: #FFFFFF">
                        <td style="padding: 5px 0; border-bottom: 1px solid #f78031">
                            <a href="/seeemail/{{$email}}/{{$date}}?utm_source={{$nameOfMail}}&utm_medium={{$nameOfMail}}&utm_campaign={{$nameOfMail}}" style="color: #000000; text-decoration: none; font-size: 14px">אם אינך רואה מייל זה לחץ כאן</a>
                        </td>
                    </tr>
                    <tr><td>
                            <a href="{{$site}}"><img class="logo" style="display:block;" src="https://www.chipi.co.il/images/media/index1/header_newsletter.jpg" width="100%" height="100" alt="icon" /></a>
                            ...
                            <table width="94%" border="0" cellspacing="0" cellpadding="0" class="table-mob">
                                <tr><td align="center">
                                        ...
                                        <div class="mob_100" style="float: left; display: inline-block; width: 33%;">
                                            ...
                                            <a/>
                                            <a class="shop" href="{{$site}}/aliexpress">
                                        <div class="mob_100" style="float: left; display: inline-block; width: 33%;">
                                            <table class="mob_100" width="100%" border="0" cellspacing="0" cellpadding="0" align="left" style="border-collapse: collapse;">
                                                <tr><td align="center" style="line-height: 14px; padding: 0 27px;">
                                                        <!-- padding --><div style="height: 20px;"> </div>
                    ...
                    <tr>
                        <td align="center" bgcolor="#ffffff" style="border-bottom-width: 1px; border-bottom-style: solid; border-bottom-color: #eff2f4; padding: 15px 10px 5px">
                             <ul style="display: inline-block; font-family: 'Raleway', sans-serif; font-size:20px; color:#000; line-height:20px; font-weight: bold;">
                                 <li style="display: inline-block"><a href="https://www.chipi.co.il/ebay/search/women%20fashion/1">נשים</a><span style="display: inline-block;margin-right: 5px;">/</span></li>
                                 <li style="display: inline-block"><a href="https://www.chipi.co.il/ebay/search/men%20fashion/1">גברים</a><span style="display: inline-block;margin-right: 5px;">/</span></li>
                                 <li style="display: inline-block"><a href="https://www.chipi.co.il/ebay/search/mobile%20phone/1">סלולאר</a><span style="display: inline-block;margin-right: 5px;">/</span></li>
                                 <li style="display: inline-block"><a href="https://www.chipi.co.il/ebay/search/makeup/1">איפור וטיפוח</a><span style="display: inline-block;margin-right: 5px;">/</span></li>
                                 <li style="display: inline-block"><a href="https://www.chipi.co.il/ebay/search/jewelry/1">תכשיטים</a><span style="display: inline-block;margin-right: 5px;">/</span></li>
                                 <li style="display: inline-block"><a href="https://www.chipi.co.il/ebay/search/kids%20fashion/1">ילדים</a></li>
                             </ul>
                        </td>
                    </tr>
                    <tr>
                            ...
                            <table width="94%" border="0" cellspacing="0" cellpadding="0">
                                <tr><td align="center" class="table-mob">
                                        ...
                                        @foreach($products as $product)
                                         ...
                                         <a class="item" href="{{$site}}/{{$product->siteName}}/product/{{$product->nameOfProduct}}/{{$product->productId}}">
                                            <table class="mob_100" width="100%" border="0" cellspacing="0" cellpadding="0" align="left" style="border-collapse: collapse;">
                    ...
                    <tr><td align="center" bgcolor="#ffffff" style="border-bottom-width: 1px; border-bottom-style: solid; border-bottom-color: #eff2f4;">
                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                <tr><td align="center">
                                        <a class="button ebayDeals"  style="background-color: #ec6409; padding: 10px; color: #fff; text-decoration: none;border: 1px solid #ec6409"  href="{{$site}}/ebay/oneDayDeals">את מבצעי צ'יפי כאסח כבר ראית ? לחץ כאן</a>
                                    </td>
                                </tr>
                            </table>
                    ...
                    <tr><td align="center" bgcolor="#ffffff" >
                            ...
                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                <tr><td align="center">
                                        <a class="button" style="background-color: #ec6409; padding: 10px; color: #fff; text-decoration: none;border: 1px solid #ec6409"  href="{{$site}}/unsubscribe/{{$email}}">הסר מרשימת התפוצה</a>
                                    </td>
                                </tr>
                            </table>
                            <!-- padding --><div style="height: 30px; line-height: 30px; font-size: 10px;"> </div>
