...
class EbayAPIForScript
{
    ...
    public function __construct()
    {
        ...
        $this->baseUrlForProductsByCategory = "http://svcs.ebay.com/services/search/FindingService/v1?OPERATION-NAME" .
            "=findItemsAdvanced&SERVICE-VERSION=1.7.0&RESPONSE-DATA-FORMAT=JSON&REST-PAYLOAD";
        $this->baseUrlForProduct = "http://open.api.ebay.com/shopping?callname=GetSingleItem&" .
            "responseencoding=JSON&siteid=0&version=967&IncludeSelector=Description,ItemSpecifics,ShippingCosts,Details,Variations";
        $this->baseUrlForSimilarProduct = "http://svcs.ebay.com/MerchandisingService?OPERATION-NAME=" .
            "getSimilarItems&SERVICE-NAME=MerchandisingService&SERVICE-VERSION=1.1.0" .
        ...
        $this->baseUrlForProductsByKeywords = "http://svcs.ebay.com/services/search/FindingService/v1?OPERATION-NAME=findItemsByKeywords&" .
            "SERVICE-VERSION=1.0.0&RESPONSE-DATA-FORMAT=JSON&REST-PAYLOAD";
        $this->baseUrlForFilters = "http://svcs.ebay.com/services/search/FindingService/v1?OPERATION-NAME" .
            "=findItemsByKeywords&SERVICE-VERSION=1.0.0&RESPONSE-DATA-FORMAT=JSON&REST-PAYLOAD";
...
//                "<Pagination><EntriesPerPage>25</EntriesPerPage><PageNumber>2</PageNumber></Pagination>" .
                ...
                "<Pagination><EntriesPerPage>" . $entriesPerPage . "</EntriesPerPage></Pagination>" .
                "</GetFeedbackRequest>";
...
for ($i = 1; $i < count($categories); $i++) {
    ...
    foreach ($productsByCategory->items as $product) {
        ...
        if (isShippingToIsrael($productInfo) && $shippingInfo->Ack == "Success") {
            $statement = $link->prepare("INSERT INTO products(itemId, picture, title,price,shippingPrice,importPrice,categoryId,
